...
export const TypingLoader = styled.ul`
  ...
  li {
    ...
    margin: 0 1px;
    &:nth-child(1) {
      animation-delay: calc(0.8 * -350ms);
    }
    &:nth-child(2) {
      animation-delay: calc(0.4 * -350ms);
    }
    &:nth-child(3) {
      animation-delay: calc(0.1 * -350ms);
    }
  }
...
export const DropZoneBloc = styled.div`
  ...
  border-color: #edaf5d;
  border-style: dashed;
  background-color: rgba(15, 51, 104, 0.7);
  color: #bdbdbd;
  outline: none;
      ...
      @media (max-width: 993px) {
        ...
        & > div {
          ...
          & > .MuiTabs-root {
            ...
            margin: 0 -5px;
            & > div {
              box-shadow: rgba(26, 57, 91, 0.9) 0px 3px 10px;
...
export const BlocProfileMenu = styled.div`
  ...
  .profil-menu-options {
    border-radius: 12px;
    background: linear-gradient(#2d7fc3 0%, #579be9 100%);
    box-shadow: 0px 4px 13px rgba(26, 57, 91, 0.63);
    color: #fff;
    padding: 0;
    .MuiMenuItem-root {
      font-family: "ProximaNovaSoftW03-Regular";
...
export const ToolBarEditor = styled.div`
  .ql-snow {
    ...
    background: rgba(31, 85, 119, 0.45);
    border: 0 !important;
    padding: 4px 8px;
    .ql-formats {
      display: flex;
...
export const ItemResultSondage = styled.div`
  ...
  .content-result-sondage {
    ...
    &::before {
      ...
      background: linear-gradient(
        to right,
        rgb(53, 131, 214, 0.39) 0%,
        rgb(65, 185, 214, 0.39) 100%
      );
    }
    span {
      display: block;
...
export const ModalItem = styled(Modal)`
  background-color: rgba(6, 20, 30, 0.94);
  overflow-y: hidden;
  &.confirmation-modal {
...
export const SimpleComment = styled.div`
  ...
  .citation-bloc {
    ...
    border: 1px solid rgba(125, 139, 147, 0.3);
    padding: 5px 18px;
    position: relative;
    overflow: hidden;
    margin-bottom: 5px;
...
export const BlocNewSondage = styled.div`
  border-radius: 13px;
  background-color: rgba(31, 85, 119, 0.43);
  color: #fff;
  padding: 20px 27px;
  margin-bottom: 26px;
  width: 100%;
...
export const BlocAddPli = styled.div`
  ...
  .new-pli-nv1 {
    ...
    .liste-files {
      ...
      .bloc-item-video-file,
      .bloc-item-sound-file {
        & > div {
          margin-bottom: 0px;
        }
      }
  ...
  .toggle-open-ouverture {
    ...
    line-height: 20px;
    background: linear-gradient(
      rgba(48, 100, 180, 0.6) 0%,
      rgba(26, 91, 147, 0.6) 100%
    );
    cursor: pointer;
    &:before {
      content: "";
...
export const ChatSpace = styled.div`
  ...
  .content-space-chat {
    ...
    .is-top-spinner {
      ...
      z-index: 11;
      background: linear-gradient(
        rgba(130, 179, 244, 0) 0%,
        rgba(128, 177, 244, 0.6) 1.48%,
        rgba(128, 177, 244, 0) 100%
      );
    }
  }
  .msg_cotainer {
